        ...
        <>
          <Box sx={{ fontWeight: 600, color: '#ffd700', mb: 0.5 }}>
            ...
            {elementHover.element.debugInfo?.attributes['data-element-type'] &&
              elementHover.element.debugInfo?.attributes[
                'data-element-index'
              ] && (
                <Box
                  component="span"
                  sx={{ fontSize: '0.65rem', color: '#ffeb3b', ml: 1 }}
                >
                  [
                  {
                    elementHover.element.debugInfo.attributes[
          ...
          {elementHover.highlightInfo && (
            <Box
              sx={{
                fontSize: '0.75rem',
                color: getHighlightColor(elementHover.highlightInfo.color),
          ...
          {showDebugInfo && elementHover.element.debugInfo && (
            ...
            >
              ...
              <Box>
                Pos: {Math.round(elementHover.element.debugInfo.rect.left)},
                {Math.round(elementHover.element.debugInfo.rect.top)}
              </Box>
              <Box>
                Size: {Math.round(elementHover.element.debugInfo.rect.width)}×
                {Math.round(elementHover.element.debugInfo.rect.height)}
              </Box>
            </Box>
          )}
        </>
